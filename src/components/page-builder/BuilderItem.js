  ...
  return (
    <div className={`pb-section-item ${item.id}__item`} key={item.id}>
      <div className="pb-section-item__input-group">
        <Heading id={item.id} updateItemData={updateItemData} />
      ...
      <div className="pb-section-item__input-group">
        ...
        <Color id={item.id} item="background" label="Background color" updateItemData={updateItemData} />
        <Color id={item.id} item="color" label="Text color" updateItemData={updateItemData} />
      </div>
    </div>
  );
}
