  ...
  return (
    <section>
      <div className='pb-section-header'>
        <h3 className='pb-section-header-heading'>
          {formatComponentName(section.component)}
        </h3>
      ...
      <div className={`pb-section pb-section-${section.component}`}>
        <div className='pb-tab-headings'>
          <button
            className={`pb-tab-link ${
              tabActiveItem === 1 ? "pb-tab-link--active" : ""
            }`}
            onClick={() => setTabActiveItem(1)}
          >
            Item
          </button>
          <button
            className={`pb-tab-link ${
              tabActiveItem === 2 ? "pb-tab-link--active" : ""
            }`}
            onClick={() => setTabActiveItem(2)}
          >
            Section
          </button>
        </div>
        ...
        <div className='pb-section-move-buttons'>
          <button
            className='button button-icon-round'
            disabled={first}
            onClick={() => moveComponent("up", section.id)}
          >
          ...
          <button
            className='button button-icon-round'
            disabled={last}
            onClick={() => moveComponent("down", section.id)}
          >
      ...
      <div className='pb-section-item'>
        ...
        <div className='pb-section-item__input-group'>
          <Color
            ...
            updateItemData={updateSectionData}
          />
        </div>
      </div>
    </div>
