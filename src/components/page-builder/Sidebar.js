...
const Sidebar = ({ addComponent }) => {
  ...
  return (
    <React.Fragment>
      ...
      <div
        className={`pb-sidebar ${sidebarIsVisible ? "pb-sidebar--open" : ""}`}
      >
        <div className='pb-tab-headings'>
          <button
            className={`pb-tab-link ${
              activeTab === 1 ? "pb-tab-link--active" : ""
            }`}
          ...
          <button
            className={`pb-tab-link ${
              activeTab === 2 ? "pb-tab-link--active" : ""
            }`}
  ...
  return (
    <div>
      ...
      <div className='pb-sidebar-component'>
        ...
        <button
          className='button pb-sidebar-component__button'
          onClick={() => addComponent("text-block", "text-block--center")}
        >
...
function BrandingTab() {
  const {
    ...
    removeColor,
  } = useContext(BrandingColourContext);
    ...
    <div>
      <div className='pb-sidebar__section'>
        ...
        <div className='pb-branding-color-tile-container'>
          {items.map((colorItem, index) => (
            <button
              className='pb-branding-color-tile'
              onClick={() => removeColor(index)}
              style={{ background: `${colorItem}` }}
            >
              <span className='pb-branding-color-tile-icon material-icons md-18'>
                remove
              </span>
            </button>
          ))}
          <button
            className='pb-branding-color-tile pb-branding-color-tile--add'
            onClick={(e) => addColor(newColor)}
          >
            <span className='pb-branding-color-tile-add-icon material-icons md-18'>
              add
            </span>
            <input
      ...
      <div className='pb-sidebar__section'>
        <h3>Buttons</h3>
        {items.length < 1
          ? "Add some colours above to apply button styling"
          : ""}
        ...
        <div className={items.length < 1 ? "pb-hide" : ""}>
          <div className='pb-sidebar__section-inner'>
            ...
            <button
              className='button'
              style={{
                backgroundColor: primaryStyling[0],
                color: primaryStyling[1],
              }}
            >
              Primary button
            </button>
            ...
            <div className='pb-branding-color-tile-container'>
              {items.map((colorItem) => (
                <button
                  className='pb-branding-color-tile'
                  onClick={() =>
                    updatePrimaryButton([colorItem, primaryStyling[1]])
                  }
                  style={{ background: `${colorItem}` }}
                ></button>
              ))}
            ...
            <div className='pb-branding-color-tile-container'>
              {items.map((colorItem) => (
                <button
                  className='pb-branding-color-tile'
                  onClick={() =>
                    updatePrimaryButton([primaryStyling[0], colorItem])
                  }
                  style={{ background: `${colorItem}` }}
                ></button>
              ))}
          ...
          <div className='pb-sidebar__section-inner'>
            ...
            <button
              className='button'
              style={{
                backgroundColor: secondaryStyling[0],
                color: secondaryStyling[1],
              }}
            >
              Secondary button
            </button>
            ...
            <div className='pb-branding-color-tile-container'>
              {items.map((colorItem) => (
                <button
                  className='pb-branding-color-tile'
                  onClick={() =>
                    updateSecondaryButton([colorItem, secondaryStyling[1]])
                  }
                  style={{ background: `${colorItem}` }}
                ></button>
              ))}
            ...
            <div className='pb-branding-color-tile-container'>
              {items.map((colorItem) => (
                <button
                  className='pb-branding-color-tile'
                  onClick={() =>
                    updateSecondaryButton([secondaryStyling[0], colorItem])
                  }
                  style={{ background: `${colorItem}` }}
                ></button>
              ))}
